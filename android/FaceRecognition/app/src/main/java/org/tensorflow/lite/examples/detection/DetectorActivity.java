      ...
      if ("success".equalsIgnoreCase(obj.getString("message"))) {
        ...
        if(resObj.getString("name").equalsIgnoreCase("unknown")) {
          ...
          if (!face_detected) {
            ...
            String checknip  = login_check.getString("nip", "");

            if (checknip.equals(name)){
              ...
              Toast.makeText(this, "Wajah Berbeda. Lakukan Deteksi Ulang", Toast.LENGTH_SHORT).show();
              finish();
            }
