...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private FloatingActionButton btnSwitchCam, fab_seach;

  private static final String KEY_USE_FACING = "use_facing";
  private Integer useFacing = null;
  private String cameraId = null;

  private TextView reyeopen_prob_info, leyeopen_prob_info, smiling_prob_info;
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    reyeopen_prob_info = findViewById(R.id.reyeopen_prob_info);
    leyeopen_prob_info = findViewById(R.id.leyeopen_prob_info);
    smiling_prob_info = findViewById(R.id.smiling_prob_info);

    btnSwitchCam = findViewById(R.id.fab_switchcam);
    fab_seach = findViewById(R.id.fab_seach);
 ...
 protected void setFragment() {
  ...
  protected void showSmiling(float smilingVal) {
    float val = smilingVal*100;
    if(val >= 60)
      smiling_prob_info.setText("Yes ("+val+"%)");
    else
      smiling_prob_info.setText("No ("+val+"%)");
  }

  protected void showREyeOpened(float eyeOpened) {
    float val = eyeOpened*100;
    if(val >= 90)
      reyeopen_prob_info.setText("Opened ("+val+"%)");
    else if(val > 40)
      reyeopen_prob_info.setText("Small Opened ("+val+"%)");
    else {
      reyeopen_prob_info.setText("Closed ("+val+"%)");
    }

  }


  protected void showLEyeOpened(float eyeOpened) {
    float val = eyeOpened*100;
    if(val >= 90)
      leyeopen_prob_info.setText("Opened ("+val+"%)");
    else if(val > 40)
      leyeopen_prob_info.setText("Small Opened ("+val+"%)");
    else {
      leyeopen_prob_info.setText("Closed ("+val+"%)");
    }
